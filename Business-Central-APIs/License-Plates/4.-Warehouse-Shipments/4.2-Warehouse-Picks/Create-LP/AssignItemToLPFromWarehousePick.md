...
Esta documentación proporciona una visión clara de cómo utilizar la API, incluyendo ejemplos de solicitudes y respuestas para guiar en su implementación.