...
**Input**:
Parameters: 
-	**NewLicensePlateCode**: Represents the code of the new **License Plate Palle**t to which the new quantities will be assigned. To create a new License Plate you must use this method:  [GenerateEmptyLP](/Plur%2De/WMS-API/Movements/Splits/GenerateEmptyLP)
