**ProcessMethod**: SplitPallet_LPSingleV2
...
To create a new License Plate you must use this method:  [GenerateEmptyLP](/Plur%2De/Business-Central-API/WMS/Movements/Splits/GenerateEmptyLP)
